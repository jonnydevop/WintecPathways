...
public class StudentModify extends AppCompatActivity {
    ...
    public void showStudentInfo() {
        ...
        Log.i("StudentModify", "showStudentInfo" + studentList.get(0).getSName());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_edit:
                editBtn();
                Log.i("StudentModify", "editstudent");
                return true;
        }
        return false;
    }
        ...
        builder.setMessage("Are you sure you want to delete?")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Log.i("StudentModify", "del student yes:" + studentID);
                        if (dbHandler.deleteStudent(studentID) == false) {
                            Toast.makeText(StudentModify.this, "Delete failed as the student is enrolled!", Toast.LENGTH_LONG).show();
                        }
                        finish();
                    }
                })
    ...
    public void editBtn() {
       ...
       Log.i("StudentModify", "editstudent1");
        Intent intent = new Intent (StudentModify.this, AddStudentActivity.class);
        Log.i("StudentModify", "editstudent2");
        intent.putExtra("studentInfo", studentID);
        Log.i("StudentModify", "editstudent3");
    ...
    public void sendEmail(View view){
        ...
        Log.i("StudentModify", "SendEmail - StudentList size:  " + studentList.size());
